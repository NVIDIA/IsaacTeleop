...
DEST="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)/python/isaacteleop_examples/robot_viz/assets"
...
echo
echo "Done. The example reads these from the source tree; nothing to install."
