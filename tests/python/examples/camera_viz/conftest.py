...
# Resolve `isaacteleop_examples.camera_viz` against the in-tree source, and with
# it the codec .so built in place by codec/build.sh.
#
...
sys.path.insert(0, str(repo_root() / "examples" / "camera_viz" / "python"))
