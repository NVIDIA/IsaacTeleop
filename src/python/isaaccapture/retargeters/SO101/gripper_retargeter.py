...
The shared :class:`~isaaccapture.retargeters.GripperRetargeter` thresholds the controller
...
(:attr:`~isaaccapture.retargeting_engine.tensor_types.ControllerInputIndex.TRIGGER_VALUE`,
