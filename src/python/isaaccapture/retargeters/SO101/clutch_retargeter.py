...
class SO101ClutchRetargeter(BaseRetargeter):
    ...
    :class:`~isaaccapture.retargeters.Se3AbsRetargeter` (node ``name="ee_pose"``, output key
    ...
    #: :meth:`~isaaccapture.retargeting_engine.interface.BaseRetargeter.connect` -- optional inputs
