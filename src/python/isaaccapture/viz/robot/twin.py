...
Nothing here imports ``isaaccapture.viz``: a backend implements this without depending on
the compositor, and :class:`~isaaccapture.viz.robot.XrTwinSession` joins the two.
"""
...
class RobotTwinPublisher(RobotTwin, Protocol):
    ...
    def publish(
        ...
        *,
        ...
        :class:`~isaaccapture.viz.robot.JointMap`. Returns immediately: nothing is drawn,
