...
"""The render thread a :class:`~isaaccapture.teleop_session_manager.TeleopSession` owns
...
Importing this module needs ``isaaccapture.viz``, so ``teleop_session`` imports it only on
...
from isaaccapture.viz.robot import RobotTwinPublisher, XrTwinSession, head_pose
...
class TwinRunner:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            twin: A :class:`~isaaccapture.viz.robot.RobotTwinPublisher`.
