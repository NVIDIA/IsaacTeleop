...
// viz's XrReferenceSpace -> OpenXR's enum. A switch with no default, so a
// value added to the enum fails to compile here rather than silently mapping
// to LOCAL and putting the app's origin back at head height.
