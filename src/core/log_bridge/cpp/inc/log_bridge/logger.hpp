...
// module's own TRACE = 5). Used by every sink that hands a record to Python's
// logging module -- log_bridge_py's PythonBridgeSink today -- so it speaks the
// exact same numbering as isaacteleop.logging_config's _LEVEL_NAMES.
