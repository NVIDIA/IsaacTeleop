...
while True:
    ...
    left_ctrl = controller_tracker.get_left_controller(deviceio_session)
    right_ctrl = controller_tracker.get_right_controller(deviceio_session)
    inputs = {
        "controllers": {
            "deviceio_controller_left": [left_ctrl],
            "deviceio_controller_right": [right_ctrl]
        }
    }
