...
class CloudXRLauncher:
    ...
    def add_launch_cloudxr_runtime_argument(parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument(
            ...
            help=(
                ...
                "and launch otherwise. Pass --no-launch-cloudxr-runtime when an "
                "external runtime is already running."
            ),
        )
    ...
    def launch_context(
        ...
        *,
        ...
        Returns :func:`contextlib.nullcontext` when runtime launch resolves false so
        callers can always use ``with CloudXRLauncher.launch_context(args):``.
