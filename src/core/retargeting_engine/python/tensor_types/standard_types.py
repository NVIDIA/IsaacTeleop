...
These definitions match the FlatBuffers schemas in TeleopCore/src/core/schema/fbs/
...
def HandInput() -> TensorGroupType:
    ...
    Schema reference: TeleopCore/src/core/schema/fbs/hand.fbs
...
def HeadPose() -> TensorGroupType:
    ...
    Schema reference: TeleopCore/src/core/schema/fbs/head.fbs
    """
