...
class ControllersSource(IDeviceIOSource):
    ...
    def poll_tracker(self, deviceio_session: Any) -> RetargeterIO:
        ...
        """
        left_snapshot = self._controller_tracker.get_left_controller(deviceio_session)
        right_snapshot = self._controller_tracker.get_right_controller(deviceio_session)
