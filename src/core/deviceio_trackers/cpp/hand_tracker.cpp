...
{
    static constexpr std::array<const char*, HandJoint_NUM_JOINTS> joint_names = { { "Palm",
                                                                                     "Wrist",
                                                                                     "Thumb_Metacarpal",
                                                                                     "Thumb_Proximal",
                                                                                     "Thumb_Distal",
                                                                                     ...
                                                                                     "Little_Distal",
                                                                                     "Little_Tip" } };
    static_assert(joint_names.size() == HandJoint_NUM_JOINTS, "joint names count must match HandJoint_NUM_JOINTS");
