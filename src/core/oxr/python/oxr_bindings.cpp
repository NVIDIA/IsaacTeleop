...
PYBIND11_MODULE(_oxr, m) {
    ...
    py::class_<oxr::OpenXRSessionHandles>(m, "OpenXRSessionHandles")
        .def(py::init<>())
        .def_property_readonly("instance", [](const oxr::OpenXRSessionHandles& self) {
             return reinterpret_cast<size_t>(self.instance);
         }, "Get OpenXR instance handle as integer")
        .def_property_readonly("session", [](const oxr::OpenXRSessionHandles& self) {
             return reinterpret_cast<size_t>(self.session);
         }, "Get OpenXR session handle as integer")
        .def_property_readonly("space", [](const oxr::OpenXRSessionHandles& self) {
             return reinterpret_cast<size_t>(self.space);
    ...
    py::class_<oxr::OpenXRSession, std::shared_ptr<oxr::OpenXRSession>>(m, "OpenXRSession")
        .def_static("create", &oxr::OpenXRSession::Create,
             py::arg("app_name"), py::arg("extensions") = std::vector<std::string>(),
        ...
        .def("__enter__", [](oxr::OpenXRSession& self) -> oxr::OpenXRSession& {
            return self;
        })
        .def("__exit__", [](oxr::OpenXRSession& self, py::object, py::object, py::object) {
