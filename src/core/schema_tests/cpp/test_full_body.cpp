...
// =============================================================================
TEST_CASE("FullBodyPosePicoT can handle is_active value properly", "[full_body][native]")
{
    // Create FullBodyPosePicoT with default values, is_active should be false.
