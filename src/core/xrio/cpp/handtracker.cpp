...
const HandData& HandTracker::Impl::get_left_hand() const { return left_hand_; }
const HandData& HandTracker::Impl::get_right_hand() const { return right_hand_; }

// Private constructor
HandTracker::Impl::Impl(XrSpace base_space,
         XrHandTrackerEXT left_hand_tracker, XrHandTrackerEXT right_hand_tracker,
         PFN_xrCreateHandTrackerEXT pfn_create, PFN_xrDestroyHandTrackerEXT pfn_destroy, PFN_xrLocateHandJointsEXT pfn_locate)
...
bool HandTracker::Impl::create_hand_tracker(XrSession session, XrHandEXT hand_type, 
