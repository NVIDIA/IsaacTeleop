...
class ManifestResolverTest(unittest.TestCase):
    ...
    def test_out_direction_defaults(self) -> None:
        entry = resolve_tracker_entry(
            {
                "name": "haptic_command",
                "direction": "out",
