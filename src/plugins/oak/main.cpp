...
try
{
    auto logger = isaaccapture::Logger::get("isaaccapture.plugins.oak.main");
...
{
    isaaccapture::Logger::get("isaaccapture.plugins.oak.main")->error("{}: {}", argv[0], e.what());
    return 1;
}
catch (...)
{
    isaaccapture::Logger::get("isaaccapture.plugins.oak.main")->error("{}: Unknown error", argv[0]);
    return 1;
}
