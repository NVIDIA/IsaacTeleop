...
try
{
    auto logger = isaaccapture::Logger::get("isaaccapture.plugins.controller_synthetic_hands.main");
...
{
    isaaccapture::Logger::get("isaaccapture.plugins.controller_synthetic_hands.main")->error("{}: {}", argv[0], e.what());
    return 1;
}
catch (...)
{
    isaaccapture::Logger::get("isaaccapture.plugins.controller_synthetic_hands.main")->error("{}: Unknown error", argv[0]);
    return 1;
}
