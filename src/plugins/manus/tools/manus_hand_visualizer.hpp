...
private:
    ...
    static constexpr uint32_t kVertSpv[] = {
        ...
        0x07230203, 0x00010000, 0x00000000, 0x0000001E, 0x00000000,
        /* OpCapability Shader              */ 0x00020011, 0x00000001,
        /* %1 OpExtInstImport "GLSL.std.450"*/ 0x0006000B, 0x00000001,
            0x4C534C47, 0x6474732E, 0x3035342E, 0x00000000,
        /* OpMemoryModel Logical GLSL450    */ 0x0003000E, 0x00000000, 0x00000001,
        /* OpEntryPoint Vertex %4 "main" %9 %12 %16 %23 */
            0x0009000F, 0x00000000, 0x00000004, 0x6E69616D, 0x00000000,
            0x00000009, 0x0000000C, 0x00000010, 0x00000017,
        /* OpDecorate %9  Location 0        */ 0x00040047, 0x00000009, 0x0000001E, 0x00000000,
        /* OpDecorate %12 Location 1        */ 0x00040047, 0x0000000C, 0x0000001E, 0x00000001,
        /* OpDecorate %23 Location 0        */ 0x00040047, 0x00000017, 0x0000001E, 0x00000000,
        /* OpMemberDecorate %14 0 BuiltIn Position */ 0x00050048, 0x0000000E, 0x00000000, 0x0000000B, 0x00000000,
        /* OpDecorate %14 Block             */ 0x00030047, 0x0000000E, 0x00000002,
        /* %2  OpTypeVoid                   */ 0x00020013, 0x00000002,
        /* %3  OpTypeFunction %2            */ 0x00030021, 0x00000003, 0x00000002,
        /* %6  OpTypeFloat 32               */ 0x00030016, 0x00000006, 0x00000020,
        /* %7  OpTypeVector %6 2            */ 0x00040017, 0x00000007, 0x00000006, 0x00000002,
        /* %8  OpTypePointer Input %7       */ 0x00040020, 0x00000008, 0x00000001, 0x00000007,
        /* %9  OpVariable %8 Input          */ 0x0004003B, 0x00000008, 0x00000009, 0x00000001,
        /* %10 OpTypeVector %6 3            */ 0x00040017, 0x0000000A, 0x00000006, 0x00000003,
        /* %11 OpTypePointer Input %10      */ 0x00040020, 0x0000000B, 0x00000001, 0x0000000A,
        /* %12 OpVariable %11 Input         */ 0x0004003B, 0x0000000B, 0x0000000C, 0x00000001,
        /* %13 OpTypeVector %6 4            */ 0x00040017, 0x0000000D, 0x00000006, 0x00000004,
        /* %14 OpTypeStruct %13 (gl_PerVertex: position only) */
            0x0003001E, 0x0000000E, 0x0000000D,
        /* %15 OpTypePointer Output %14     */ 0x00040020, 0x0000000F, 0x00000003, 0x0000000E,
        /* %16 OpVariable %15 Output        */ 0x0004003B, 0x0000000F, 0x00000010, 0x00000003,
        /* %17 OpTypeInt 32 signed          */ 0x00040015, 0x00000011, 0x00000020, 0x00000001,
        /* %18 OpConstant int 0             */ 0x0004002B, 0x00000011, 0x00000012, 0x00000000,
        /* %19 OpConstant float 0.0         */ 0x0004002B, 0x00000006, 0x00000013, 0x00000000,
        /* %20 OpConstant float 1.0         */ 0x0004002B, 0x00000006, 0x00000014, 0x3F800000,
        /* %21 OpTypePointer Output vec4    */ 0x00040020, 0x00000015, 0x00000003, 0x0000000D,
        /* %22 OpTypePointer Output vec3    */ 0x00040020, 0x00000016, 0x00000003, 0x0000000A,
        /* %23 OpVariable %22 Output        */ 0x0004003B, 0x00000016, 0x00000017, 0x00000003,
        /* %4  OpFunction void None %3      */ 0x00050036, 0x00000002, 0x00000004, 0x00000000, 0x00000003,
        /* %5  OpLabel                      */ 0x000200F8, 0x00000005,
        /* %24 OpLoad vec2 %9               */ 0x0004003D, 0x00000007, 0x00000018, 0x00000009,
        /* %25 OpCompositeExtract float %24[0] */ 0x00050051, 0x00000006, 0x00000019, 0x00000018, 0x00000000,
        /* %26 OpCompositeExtract float %24[1] */ 0x00050051, 0x00000006, 0x0000001A, 0x00000018, 0x00000001,
        /* %27 OpCompositeConstruct vec4 (x,y,0,1) */
            0x00070050, 0x0000000D, 0x0000001B, 0x00000019, 0x0000001A, 0x00000013, 0x00000014,
        /* %28 OpAccessChain %21 %16[0]     */ 0x00050041, 0x00000015, 0x0000001C, 0x00000010, 0x00000012,
        /* OpStore gl_Position = %27        */ 0x0003003E, 0x0000001C, 0x0000001B,
        /* %29 OpLoad vec3 %12              */ 0x0004003D, 0x0000000A, 0x0000001D, 0x0000000C,
        /* OpStore fragColor = %29          */ 0x0003003E, 0x00000017, 0x0000001D,
        /* OpReturn                         */ 0x000100FD,
    ...
    static constexpr uint32_t kFragSpv[] = {
        ...
        /* OpExecutionMode OriginUpperLeft  */ 0x00030010, 0x00000004, 0x00000007,
        /* OpDecorate %9  Location 0        */ 0x00040047, 0x00000009, 0x0000001E, 0x00000000,
        /* OpDecorate %12 Location 0        */ 0x00040047, 0x0000000C, 0x0000001E, 0x00000000,
        /* %2  OpTypeVoid                   */ 0x00020013, 0x00000002,
        /* %3  OpTypeFunction %2            */ 0x00030021, 0x00000003, 0x00000002,
        /* %6  OpTypeFloat 32               */ 0x00030016, 0x00000006, 0x00000020,
        /* %7  OpTypeVector %6 3            */ 0x00040017, 0x00000007, 0x00000006, 0x00000003,
        /* %8  OpTypePointer Input %7       */ 0x00040020, 0x00000008, 0x00000001, 0x00000007,
        /* %9  OpVariable %8 Input          */ 0x0004003B, 0x00000008, 0x00000009, 0x00000001,
        /* %10 OpTypeVector %6 4            */ 0x00040017, 0x0000000A, 0x00000006, 0x00000004,
        /* %11 OpTypePointer Output %10     */ 0x00040020, 0x0000000B, 0x00000003, 0x0000000A,
        /* %12 OpVariable %11 Output        */ 0x0004003B, 0x0000000B, 0x0000000C, 0x00000003,
        /* %13 OpConstant float 1.0         */ 0x0004002B, 0x00000006, 0x0000000D, 0x3F800000,
        /* %4  OpFunction void None %3      */ 0x00050036, 0x00000002, 0x00000004, 0x00000000, 0x00000003,
        /* %5  OpLabel                      */ 0x000200F8, 0x00000005,
        /* %14 OpLoad vec3 %9               */ 0x0004003D, 0x00000007, 0x0000000E, 0x00000009,
        /* %15 OpCompositeExtract float %14[0] */ 0x00050051, 0x00000006, 0x0000000F, 0x0000000E, 0x00000000,
        /* %16 OpCompositeExtract float %14[1] */ 0x00050051, 0x00000006, 0x00000010, 0x0000000E, 0x00000001,
        /* %17 OpCompositeExtract float %14[2] */ 0x00050051, 0x00000006, 0x00000011, 0x0000000E, 0x00000002,
        /* %18 OpCompositeConstruct vec4    */ 0x00070050, 0x0000000A, 0x00000012,
            0x0000000F, 0x00000010, 0x00000011, 0x0000000D,
        /* OpStore outColor = %18           */ 0x0003003E, 0x0000000C, 0x00000012,
        /* OpReturn                         */ 0x000100FD,
        /* OpFunctionEnd                    */ 0x00010038,
    };
    ...
    // Projection modes
    // -----------------------------------------------------------------------
    enum class ProjectionMode { Top, Side };

    // -----------------------------------------------------------------------
    // Per-hand cached scale/3-D center (locked on first data frame, reset on disconnect)
    // -----------------------------------------------------------------------
    struct HandState { float scale = 0.0f; float cx = 0.0f, cy = 0.0f, cz = 0.0f; };
...
inline HandVisualizer::~HandVisualizer()
{
    ...
    if (m_vbuf)     vkDestroyBuffer(m_dev, m_vbuf, nullptr);
    if (m_vbuf_mem) vkFreeMemory(m_dev, m_vbuf_mem, nullptr);

    if (m_sem_image_avail) vkDestroySemaphore(m_dev, m_sem_image_avail, nullptr);
    if (m_sem_render_done) vkDestroySemaphore(m_dev, m_sem_render_done, nullptr);
    if (m_fence_in_flight) vkDestroyFence(m_dev, m_fence_in_flight, nullptr);

    destroySwapchainResources();

    if (m_render_pass) vkDestroyRenderPass(m_dev, m_render_pass, nullptr);
    if (m_pipe_layout) vkDestroyPipelineLayout(m_dev, m_pipe_layout, nullptr);
...
inline void HandVisualizer::initXlib()
{
    ...
    m_win = XCreateSimpleWindow(m_dpy, RootWindow(m_dpy, screen),
                                0, 0, kWindowW, kWindowH, 0,
...
inline void HandVisualizer::initVulkan()
{
    ...
    for (auto& pd : pdevs)
    {
        ...
        {
            if (!(qfams[i].queueFlags & VK_QUEUE_GRAPHICS_BIT)) continue;
...
inline void HandVisualizer::createSwapchain()
{
    ...
    // Choose extent
    m_sc_extent = (caps.currentExtent.width != UINT32_MAX)
                  ? caps.currentExtent
                  : VkExtent2D{ kWindowW, kWindowH };
...
inline void HandVisualizer::createVertexBuffer()
{
    ...
    const uint32_t required = VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT |
...
{
    for (auto fb : m_framebuffers) if (fb) vkDestroyFramebuffer(m_dev, fb, nullptr);
    m_framebuffers.clear();
    for (auto iv : m_sc_views)    if (iv) vkDestroyImageView(m_dev, iv, nullptr);
    m_sc_views.clear();
    if (m_swapchain) { vkDestroySwapchainKHR(m_dev, m_swapchain, nullptr); m_swapchain = VK_NULL_HANDLE; }
}

// ---------------------------------------------------------------------------
inline std::pair<float,float> HandVisualizer::project(
    const ManusVec3& p, ProjectionMode mode)
{
...
// ---------------------------------------------------------------------------
inline void HandVisualizer::buildHandGeometry(
    const std::vector<SkeletonNode>& nodes,
    const std::vector<NodeInfo>&     info,
    const std::array<float, 3>&      colour,
    ProjectionMode mode,
    ...
    std::vector<Vertex>&             verts)
{
    ...
    ManusVec3 center3d; center3d.x = cx; center3d.y = cy; center3d.z = cz;
    ...
    for (auto& ni : info)
    {
        ...
        if (ni.parentId == ni.nodeId) continue;
        auto it_child  = pos_map.find(ni.nodeId);
        auto it_parent = pos_map.find(ni.parentId);
        if (it_child == pos_map.end() || it_parent == pos_map.end()) continue;
    ...
    while (running)
    {
        ...
        while (XPending(m_dpy))
        {
            ...
            if (ev.type == ClientMessage &&
                static_cast<Atom>(ev.xclient.data.l[0]) == m_wm_del)
            {
                running = false;
            }
            if (ev.type == KeyPress)
        ...
        verts.push_back({-1.0f,  0.0f, kG, kG, kG}); verts.push_back({ 1.0f,  0.0f, kG, kG, kG}); // horizontal
        verts.push_back({ 0.0f,  1.0f, kG, kG, kG}); verts.push_back({ 0.0f, -1.0f, kG, kG, kG}); // vertical
        ...
        if (has_left)
        {
            buildHandGeometry(left_nodes, left_info, kLeftColor,
                ProjectionMode::Top,  m_left_state.scale,
                m_left_state.cx, m_left_state.cy, m_left_state.cz,
                -0.5f, +0.5f, verts);
            buildHandGeometry(left_nodes, left_info, kLeftColor,
                ProjectionMode::Side, m_left_state.scale,
                m_left_state.cx, m_left_state.cy, m_left_state.cz,
                -0.5f, -0.5f, verts);
        }
        if (has_right)
        {
            buildHandGeometry(right_nodes, right_info, kRightColor,
                ProjectionMode::Top,  m_right_state.scale,
                m_right_state.cx, m_right_state.cy, m_right_state.cz,
                +0.5f, +0.5f, verts);
            buildHandGeometry(right_nodes, right_info, kRightColor,
                ProjectionMode::Side, m_right_state.scale,
                m_right_state.cx, m_right_state.cy, m_right_state.cz,
                +0.5f, -0.5f, verts);
        }
        ...
        uint32_t vert_count = static_cast<uint32_t>(
            std::min<size_t>(verts.size(), kMaxVertices));
        ...
        VkResult acquire_result = vkAcquireNextImageKHR(
            m_dev, m_swapchain, UINT64_MAX, m_sem_image_avail, VK_NULL_HANDLE, &img_idx);
